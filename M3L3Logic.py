...
statuses = [ (_,) for _ in (['Prototyping', 'In Developement', 'Completed', 'Updated', 'Abandoned/Not Supported', '(harap menggunakan format capslock yang sama)'])]
...
class DB_Manager:
    ...
    def insert_project(self, data):
        sql = "INSERT OR IGNORE INTO projects (user_id, project_name, url, status_id) VALUES (?, ?, ?, ?)" # Masukkan kueri SQL yang benar di sini
